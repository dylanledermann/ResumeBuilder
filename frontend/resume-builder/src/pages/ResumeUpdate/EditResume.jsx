    ...
    switch (currentPage) {
      ...
      case "work-experience":
        ...
        ({ company, role, startDate, endDate }, index) => {
          ...
          if(!startDate || !endDate) errors.push(`Start and End date are required in experience ${index + 1}`);
        }
        );
        break;
      ...
      case "education-info":
        resumeData.education.forEach(
          ({ degree, institution, startDate, endDate }, index) => {
            ...
            if(!startDate || !endDate) errors.push(`Start and End date are in education ${index+1}`);
          }
        );
        break;
      ...
      case "projects":
        resumeData.projects.forEach(
          ({ title, description }, index) => {
            if(!title.trim()) errors.push(`Title is required in project ${index+1}`);
      ...
      case "certifications":
        if(resumeData.certifications.length > 0){
          resumeData.certifications.forEach(
            ({ title, issuer }, index) => {
              if(!title.trim()) errors.push(`Title is required in certification ${index+1}`);
